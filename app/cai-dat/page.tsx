        ...
        return (
            <div className="p-5 pb-24 flex items-center justify-center min-h-screen bg-background">
                <div className="flex flex-col items-center gap-3">
                    ...
                    <div className="text-primary font-medium">Đang tải cài đặt...</div>
                </div>
            </div>
        );
    }
        ...
        <div className="p-5 pb-24 min-h-screen bg-background">
            ...
            <div className="clay-card p-5 mb-5">
                ...
                <div className="mb-4 pb-4 border-b border-orange-100">
                    ...
                    <button
                        ...
                        disabled={syncing}
                        className="clay-button w-full py-3 text-sm flex items-center justify-center gap-2"
                    >
                ...
                <div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        <button
                            ...
                            disabled={exporting}
                            className="px-3 py-3 bg-white border-2 border-green-500 text-green-700 font-bold text-sm rounded-xl hover:bg-green-50 disabled:opacity-50 transition-all shadow-sm"
                        >
                            Tháng này
                        </button>
                        <button
                        ...
                        <button
                            ...
                            disabled={exporting}
                            className="px-3 py-3 bg-green-600 text-white font-bold text-sm rounded-xl hover:bg-green-700 disabled:opacity-50 transition-all shadow-sm"
                        >
                            Tất cả
                        </button>
                    </div>
            ...
            <div className="clay-card p-5 mb-5">
                ...
                <div className="relative mb-4">
                    <input
                        ...
                        className="w-full px-4 py-3 pl-11 border-2 border-orange-100 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary text-foreground font-medium transition-all outline-none"
                    />
                ...
                <div className="space-y-3 max-h-96 overflow-y-auto pr-1 custom-scrollbar">
                    {filteredProducts.map((product) => (
                        <div key={product.id} className="border border-orange-100 rounded-xl p-4 bg-orange-50/30 hover:bg-white hover:shadow-md transition-all">
                            <div className="flex items-center justify-between mb-2">
                                <h3 className="font-bold text-foreground text-lg">{product.ten_hang}</h3>
                            ...
                            {editingProduct === product.id ? (
                                <div className="space-y-3 bg-white p-3 rounded-lg border border-orange-100 shadow-inner">
                                    <div className="flex gap-2">
                                        <div className="flex-1">
                                            ...
                                            <input
                                                ...
                                                className="w-full px-3 py-2 text-sm border-2 border-orange-100 rounded-lg text-foreground font-semibold focus:border-primary outline-none"
                                ...
                                <div>
                                    <div className="flex items-center gap-4 text-sm text-gray-600 font-medium mb-3">
                                        <span className="bg-white px-2 py-1 rounded border border-orange-100">Đơn vị: {product.don_vi}</span>
                                        <span className="bg-white px-2 py-1 rounded border border-orange-100">Lãi: {product.ty_le_lai_mac_dinh}%</span>
                                        <span className="bg-white px-2 py-1 rounded border border-orange-100">Min: {product.nguong_canh_bao}</span>
                                    </div>
                                    <button
                                        onClick={() => setEditingProduct(product.id)}
                                        className="flex items-center gap-1 text-sm text-primary font-bold hover:text-orange-700 transition-colors"
                                    >
            ...
            <div className="clay-card p-5 mb-5">
                ...
                <div className="space-y-4">
                    ...
                    <button
                        ...
                        className="clay-button w-full py-3 flex items-center justify-center gap-2 mt-2"
                    >
            ...
            <div className="clay-card p-5">
                ...
                <div className="space-y-3">
                    <div className="flex justify-between items-center p-3 bg-white rounded-xl border border-orange-50">
                        <span className="text-gray-600 font-medium flex items-center gap-2">
                            <Package className="w-4 h-4" /> Sản phẩm
                        </span>
                        <span className="font-bold text-foreground text-lg">{systemStats?.products || 0}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-white rounded-xl border border-orange-50">
                        <span className="text-gray-600 font-medium flex items-center gap-2">
                            <ArrowDownToLine className="w-4 h-4" /> Đơn nhập
                        </span>
                        <span className="font-bold text-foreground text-lg">{systemStats?.nhap_hang?.toLocaleString() || 0}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-white rounded-xl border border-orange-50">
                        <span className="text-gray-600 font-medium flex items-center gap-2">
                            <ShoppingCart className="w-4 h-4" /> Đơn bán
                        </span>
                        <span className="font-bold text-foreground text-lg">{systemStats?.ban_hang?.toLocaleString() || 0}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-white rounded-xl border border-orange-50">
                        <span className="text-gray-600 font-medium flex items-center gap-2">
